...
namespace SharedContracts.DataPointCollections
{
    public class ChargingDataPoints
    {
        ...
        /// </summary>
        public DecimalDataPoint CurrentChargingPower = new() { Label = "Aktuelle Lade-Leistung", Unit = "W", MaxValue = 12000, DecimalDigits = 1, History = new() { DataHistoryLength = 100, AggregationTimeSpan=TimeSpan.FromMinutes(1), AggregationHistoryLength = 1440, AggregationType = AggregationType.Average} };
        /// <summary>
